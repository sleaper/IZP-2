...
# test compilation
echo "Compilation: gcc -std=c11 -DNDEBUG -Wall -Wextra -Werror maze.c -o maze"
gcc -std=c11 -DNDEBUG -Wall -Wextra -Werror maze.c -o maze > ./results/compilation_out.txt 2>&1
ret=$?
if [ $ret -ne 0 ]; then
